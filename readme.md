...
- `Except` - Create a type from an object type without certain keys.
	<details>
	<summary>
		Example | <a href="https://www.typescriptlang.org/play?#code/JYWwDg9gTgLgBDAnmApnA3gUQB4GMVgwC+cAZlBCHAORKoC0pKAzjNQNwBQndaAYhAhwAvBk4BDAFxwAdgFcQAIxRQui6ayjAZAcy65piwQBsU4mVyJceyfoIDqwGAAsIcmAEERcHPkIAeAQgAGhpxajgAHxpcagA+LgB6ROE4jHU4TW0dKyA">TS Playground</a> | <a href="source/except.d.ts">Source</a>
	</summary>
